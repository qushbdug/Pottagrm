...
📝 **اكتب موقع الشبكة أو اكتب "تخطي" للتخطي:**""",
            ...
            try:
                ...
                cursor.execute('''
                    INSERT INTO networks (supplier_id, name, provider, description, location, created_by, is_active, is_approved)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?)
                ''', (user['id'], network_name, provider, description, location, user['id'], 1, 1))
